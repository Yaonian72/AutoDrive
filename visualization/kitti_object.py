...
class kitti_object(object):
    ...
    def get_lidar_filename(self, idx):
        assert idx < self.num_samples
        lidar_filename = os.path.join(self.lidar_dir, "%06d.bin" % (idx))
        return lidar_filename
...
class kitti_object_video(object):
    ...
    def get_object(self, idx):
        assert idx < self.num_samples
        return self.frame_dict_2d[idx], self.frame_dict_3d[idx], self.frame_dict_obj[idx], self.frame_dict_id[idx]
    ...
    def get_calibration(self, unused=None):
        return self.calib


def viz_kitti_video():
    video_path = os.path.join(ROOT_DIR, "/home/yzy/Downloads/2011_09_26")
...
def show_lidar_with_depth(
    ...
    # file = "/home/yzy/PycharmProjects/mmdetection3d/checkpoints/trained_model/result/000006/000006_pred.ply"
    # m = mlab.pipeline.surface(mlab.pipeline.open(file))
    # m.actor.actor.rotate_z(-90)
